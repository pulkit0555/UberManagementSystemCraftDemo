...
import org.example.exception.InvalidRideParamException;
import org.example.exception.TripNotFoundException;
import org.example.exception.TripStatusException;
...
import org.example.strategy.OptimalDriverStrategy;
...
class TripManagerTest {
  ...
  void setup() {
    ...
    driver1 = new Driver(1, "Driver1",918171651, "d1@gmail.com", "DL123");
    driver2 = new Driver(2, "Driver2", 918171651, "d1@gmail.com", "DL123");
  ...
  void test_updateTripFareBasedOnNewDetails() {
    ...
    // Then.
    assertEquals(400, tripManager.endTrip(driver));
  }
  ...
  void test_withdrawTrip() {
    ...
    // Then.
    assertEquals(TripStatus.WITHDRAWN, trip.getStatus());
  }
